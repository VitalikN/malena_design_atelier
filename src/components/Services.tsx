  ...
  return (
    ...
    >
      <div className="container mx-auto xs:py-2 xs:px-2 md:px-6 lg:px-8 md:pb-2 lg:pb-2">
        <motion.h2
          className="p-2 text-center xs:text-26 md:text-30 text-transparent bg-gradient-to-r from-gradientFrom via-gradientVia to-gradientTo bg-clip-text font-semibold"
        ...
        <motion.ul
          className="grid sm:grid-cols-2 xl:grid-cols-4 gap-4 font-medium"
          initial="hidden"
          whileInView="visible"
          variants={{
            hidden: {},
